...
public class cetak extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kd_sewa = new javax.swing.JTextField();
        ...
        jLabel1.setText("Cetak Nota Penjualan");
        jDesktopPane1.add(jLabel1);
        jLabel1.setBounds(80, 10, 270, 25);
        ...
        kd_sewa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kd_sewaActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(kd_sewa, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(kd_sewa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2)
    ...
    private void kd_sewaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kd_sewaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_kd_sewaActionPerformed

    private void txtcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcariActionPerformed
        String transaksi = kd_sewa.getText();  // TODO add your handling code here:
        try{
            Class.forName("com.mysql.jdbc.Driver").newInstance();
            Connection koneksi = (Connection) DriverManager.getConnection
            ("jdbc:mysql://127.0.0.1/tokoinstinkprint", "root", "");
            Statement statement = (Statement) koneksi.createStatement();
            String sql="select * from transaksi where factur='"+kd_sewa.getText()+"'";
            ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
                jTextArea1.setText
                    ("                                *** Instink Print ***"+
                    "\n                 Jual Tinta Dan Toner Serta Service Printer"+
                    "\nJl.Centex No.02 Ciracas Jakarta Timur tlp.081281145302"+
                    "\n============================================"+
                    "\n============TRANSAKSI PENJUALAN============" + "\n"
                    + "No. Faktur                 : " + rs.getString(1)+ "\n"
                    + "Id Customer              : " + rs.getString(2)+ "\n"
                    + "Nama                        : " + rs.getString(3)+ "\n"
                    + "Tanggal Transaksi    : " + rs.getString(4)+ "\n"
                    + "Nama Barang           : " + rs.getString(6) + "\n"
                    + "Banyak                     : " + rs.getString(7) +"\n"
                    + "Tarif                          : " + rs.getString(8) +"\n"
                    + "Total                         : " + rs.getString(9) +"\n"
                    +

                    "\n============================================"+
                    "\n             Terimasih Telah Membeli Ditempat Kami,"+
                    "\n                 Demi Kenyamanan Pelanggan."+
                    "\n          Mohon Mengecek Kembali Pembayaran Anda."+
                    "\nPerhatian Barang Yang Sudah dibeli Tidak Bisa Dikembalikan."+
                    "\n");
            }else{
    ...
    private javax.swing.JTextField kd_sewa;
